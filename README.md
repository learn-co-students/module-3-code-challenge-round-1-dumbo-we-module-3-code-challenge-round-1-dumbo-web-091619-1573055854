...
1. -- As a user, when the page loads, I should see a list of beer names retrieved from an API on the left hand side of the screen.

2. -- As a user, when I click a beer name, the application should reveal 
* ** more information about that particular beer.

3. -- As a user, when looking at the details of a beer, 
* I can edit the current description of a beer. 
